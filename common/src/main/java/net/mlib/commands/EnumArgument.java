...
import net.mlib.mixin.IMixinArgumentTypeInfos;
...
public class EnumArgument< T extends Enum< T > > implements ArgumentType< T > {
	private static final Dynamic2CommandExceptionType INVALID_ENUM = new Dynamic2CommandExceptionType( ( found, constants )->Component.translatable( "commands.mlib.arguments.enum.invalid", constants, found ) );
